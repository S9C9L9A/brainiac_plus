...
class AgentRegistry {
  final List<AgentProfile> _agents = [
    const AgentProfile(
      ...
      systemPrompt:
          'You are the Dashboard Agent. Focus on metrics, charts, and dashboard widgets.',
    ),
    const AgentProfile(
      id: 'terminal',
      name: 'Terminal Agent',
      ...
      systemPrompt:
          'You are the Terminal Agent. Focus on terminal UI and shell command flows.',
    ),
    const AgentProfile(
      id: 'packages',
      name: 'Packages Agent',
      ...
      systemPrompt:
          'You are the Packages Agent. Focus on package management UI and services.',
    ),
    const AgentProfile(
      id: 'automation',
      ...
      systemPrompt:
          'You are the Automation Agent. Focus on automation flows and scheduling.',
    ),
    const AgentProfile(
      id: 'file_manager',
      ...
      systemPrompt:
          'You are the File Manager Agent. Focus on file browsing and operations.',
    ),
    const AgentProfile(
      id: 'ai_assistant',
      ...
      systemPrompt:
          'You are the AI Assistant Agent. Focus on chat UI and orchestration logic.',
    ),
    const AgentProfile(
      id: 'core',
      name: 'Core Agent',
      ...
      systemPrompt:
          'You are the Core Agent. Focus on shared services and platform layers.',
    ),
    ...
    const AgentProfile(
      ...
      systemPrompt:
          'You are the Code Review Agent. Analyze code quality, find smells, secrets, and async issues.',
    ),
    const AgentProfile(
      id: 'test',
      name: 'Test Agent',
      ...
      systemPrompt:
          'You are the Test Agent. Recommend tests and enforce coverage targets.',
    ),
    const AgentProfile(
      id: 'safety',
      name: 'Safety Agent',
      ...
      systemPrompt:
          'You are the Safety Agent. Block dangerous operations and enforce locked-file rules.',
    ),
    const AgentProfile(
      id: 'action',
      name: 'Action Agent',
      ...
      systemPrompt:
          'You are the Action Agent. Map user requests to concrete app operations.',
    ),
    const AgentProfile(
      id: 'coordinator',
      ...
      systemPrompt:
          'You are the Coordinator Agent. Run all specialized agents and aggregate results.',
    ),
  ];

  List<AgentProfile> get agents => List.unmodifiable(_agents);

  AgentProfile get defaultAgent =>
      _agents.firstWhere((a) => a.id == 'ai_assistant');
