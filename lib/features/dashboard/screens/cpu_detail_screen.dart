...
class CpuDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CpuDetailScreen> createState() => _CpuDetailScreenState();
}

class _CpuDetailScreenState extends ConsumerState<CpuDetailScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(processControllerProvider.notifier).loadTopCpuProcesses());
  }
